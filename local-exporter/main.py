...
def set_init_values():
    ...
    set_values(cpu=(cpu_usage.labels(db_pod="db1"), random.randint(1, 50)), mem=(mem_usage.labels(db_pod="db1"), random.randint(1, 50)))


def set_allerting_values():
    print("Set Allerting Values")
    set_values(cpu=(cpu_usage.labels(db_pod="db1"), random.randint(80, 100)), mem=(mem_usage.labels(db_pod="db1"), random.randint(80, 100)))
